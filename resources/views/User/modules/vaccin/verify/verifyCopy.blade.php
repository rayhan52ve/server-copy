                        ...
                        <div class="covid19-body" style="height: 590px; margin-top: -380px;">
                            ...
                            <table class="table-data">
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['certification_no']}}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['nid_number']}}</td>
                                    <td class="text-end px-2 py-0 fw-medium" style="max-width: 160px;">
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px; max-width: 135px;">{{$data['name_dose_one']}}</td>
                                </tr>
                                <tr>
                                    <td class="text-end px-2 py-0 fw-medium">
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['passport_no']}}</td>
                                    <td class="text-end px-2 py-0 fw-medium" style="max-width: 160px;">
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['nationality']}}</td>
                                    <td class="text-end px-2 py-0 fw-medium" style="max-width: 160px;">
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px; max-width: 135px;">{{$data['name_dose_two']}}</td>
                                </tr>
                                <tr>
                                    <td class="text-end px-2 py-0 fw-medium">
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['name']}}</td>
                                    <td class="text-end px-2 py-0 fw-medium" style="max-width: 160px;">
                                        <span style="font-size: 13px;">Vaccination Center:</span>
                                        <small class="d-block" style="font-size: 10.6px;">টিকা প্রদানের
                                            কেন্দ্র:</small>
                                    </td>
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px; max-width: 135px;">{{$data['vaccination_center']}}</td>
                                </tr>
                                <tr>
                                    <td class="text-end px-2 py-0 fw-medium">
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['dob']}}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px;">{{$data['gender']}}</td>
                                    <td class="text-end px-2 py-0 fw-medium" style="max-width: 160px;">
                                        <span style="font-size: 13px;">Total Doses Given:</span>
                                        <small class="d-block" style="font-size: 10.6px;">মোট ডোজ সংখ্যা:</small>
                                    </td>
                                    <td class="px-2 py-0 fw-medium" style="font-size: 13px; max-width: 135px;">{{$data['total_dose']}}</td>
                                </tr>
