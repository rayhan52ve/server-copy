    ...
    <div class="col-lg-12 mt-5">
        <div class="card p-1" style="border: 2px solid rgb(7, 95, 136); border-radius: 5px;">
            <marquee behavior="" direction="">
                <h4 class="mt-2"><b>নোটিশঃ- {{ @$notice->sign_copy }}</b></h4>
            </marquee>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal">
                        <i class="fa-solid fa-plus"></i> অর্ডার সাইন কপি
                    </button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createModallLabel">অর্ডার সাইন কপি</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal mt-5" action="{{ route('user.sign-copy.store') }}"
                            ...
                            <div class="row">
                                ...
                                @else
                                    <input type="hidden" name="price"
                                        value="{{ $message->sign_copy_price ?? null }}">
                                @endif
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-info"
                                    {{ $submitStatus->sign_copy == 1 ? '' : 'disabled' }}>Submit</button>
                            </div>
                        </form>
                    </div>
                    {{-- <div class="">
