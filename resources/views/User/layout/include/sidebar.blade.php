        ...
        <nav class="sidebar-nav mt-3 mt-md-0">
            <ul id="sidebarnav">
                ...
                @if ($hideUnhide->recharge_bkash == 1)
                    <li> <a class="waves-effect waves-dark" href="{{ route('bkash.index') }}" aria-expanded="false"><i
                                class="fa-solid fa-bangladeshi-taka-sign"></i><span class="hide-menu">রিচার্জ</span></a>
                    </li>
                @endif
                ...
                @if ($whatsappGroup)
                    <li> <a class="waves-effect waves-dark" href="{{ $whatsappGroup }}" aria-expanded="false"><i
                                class="fa-brands fa-whatsapp"></i><span class="hide-menu">WhatsApp গ্রুপ</span></a>
                    </li>
                @endif

                <li class="d-md-none"> <a class="waves-effect waves-dark" href="{{ route('user.profile.settings') }}"
                        aria-expanded="false"><i class="fa-solid fa-user"></i><span
