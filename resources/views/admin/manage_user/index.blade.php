                            ...
                            <tr>
                                ...
                                <td>
                                    @if (auth()->user()->is_admin == 1 || @$moderatorAccess->user_edit == 1)
                                        ...
                                        <form action="{{ route('admin.manage-user.destroy', $item->id) }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.manage-user.update', $item->id) }}"
                                                ...
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <input type="text" value="{{ $item->decryptedPassword }}" class="form-control" id="password"
                                                        name="password">
                                                    <label for="file" class="form-label">ব্যালেন্স(টাকা)</label>
                                                    <input type="number" class="form-control" value="{{ $item->balance }}"
