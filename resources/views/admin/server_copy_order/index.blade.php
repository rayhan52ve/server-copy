                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group-sm btn-group-vertical ">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form
                                                                action="{{ route('admin.refund.serverCopy', $item->id) }}"
                                                                ...
                                                                <div class="col-md-10">
                                                                    ...
                                                                    @else
                                                                        <input type="hidden" name="price"
                                                                            value="{{ \App\Models\Message::first()->server_copy_price ?? null }}">
                                                                    @endif
                                            ...
                                            <div class="modal fade" id="uploadModal{{ $item->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Form for file upload -->
                                                            <form action="{{ route('admin.server-file.upload') }}"
                                            ...
                                            <form action="{{ route('admin.server-copy.destroy', $item->id) }}"
