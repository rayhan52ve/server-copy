            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="footer-widget">
                    <a href="index.html" class="footer-logo">
                        ...
                        <img src="{{asset($logo->logo_image??null)}}" height="100px" width="100px" alt="Image">
{{--                        Medical Care--}}
                    </a>
                    <p class="comp-desc">
                        {{$footer->details??null}}
                ...
                <div class="footer-widget">
                    ...
                    <ul class="contact-info list-style">
                        ...
                        <li>
                            ...
                            <h6>Email</h6>
                            <a href="mailto:{{$links->email??null}}"><span>{{$links->email??null}}</span></a>
                        </li>
                        <li>
    ...
    <p class="copyright-text"><i class="ri-copyright-line"></i>  {{$footer->credit??null}}</p>
</footer>
