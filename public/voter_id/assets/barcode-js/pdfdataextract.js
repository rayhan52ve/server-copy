    ...
    (e.fn.fileinputLocales = {}),
        ...
        (t = {
            ...
            round: function (e) {
                return (
                    (e = parseFloat(e)),
                    isNaN(e) ? 0 : Math.floor(Math.round(e))
                );
            },
            getArray: function (e) {
                var t,
            ...
            spliceArray: function (t, i, a) {
                ...
                for (
                    s = e.extend(!0, [], t), a && s.reverse(), r = 0;
                    r < s.length;
                    r++
                )
                    r !== i && ((o[n] = s[r]), n++);
        ...
        ((i = function (i, a) {
            (this.$element = e(i)),
                ...
                this._validate() &&
                    ...
                    (this.isPreviewable || this.isIE9) &&
                        (this._init(a), this._listen()),
            ...
            _init: function (i, a) {
                ...
                (l.options = i),
                    ...
                    (l.progressTemplate = n.replace(
                        "{class}",
                        l.progressClass
                    )),
                    (l.progressInfoTemplate = n.replace(
                        "{class}",
                        l.progressInfoClass
                    )),
                    (l.progressPauseTemplate = n.replace(
                        "{class}",
                        l.progressPauseClass
                    )),
                    (l.progressCompleteTemplate = n.replace(
                        "{class}",
                        l.progressCompleteClass
                    )),
                    (l.progressErrorTemplate = n.replace(
                        "{class}",
                    ...
                    (l.$preview = t.getElement(
                        i,
                        "elPreviewImage",
                        s.find(".file-preview-thumbnails")
                    )),
                    (l.$previewStatus = t.getElement(
                        i,
                        "elPreviewStatus",
                        s.find(".file-preview-status")
                    )),
                        ...
                        (i = a.resumableManager =
                            {
                                ...
                                getUploadedSize: function () {
                                    var e =
                                        i.processedResumables() * i.chunkSize;
            ...
            _initTemplateDefaults: function () {
                ...
                (i =
                    ...
                    C._isPdfRendered() &&
                        (g = C.pdfRendererTemplate.replace(
                            "{renderer}",
                            C._encodeURI(C.pdfRendererUrl)
                        )),
                    (C.defaults = {
                        layoutTemplates: {
                            main1: i,
                    ...
                    e.each(C.defaults, function (t, i) {
                        "allowedPreviewTypes" !== t
                            ...
                            : void 0 === C.allowedPreviewTypes &&
                              (C.allowedPreviewTypes = i);
                    }),
                    ...
                    get: function (e, a) {
                        ...
                        return h && h.length
                            ? ((a = void 0 === a || a),
                              ...
                              (r = m
                                  ? v(n, h, l, d, o, u, c)
                                  : v("generic", h, l, d, o, u, c, n).setTokens(
                                        { content: p.content[e] }
                                    )),
                              p.tags.length &&
                                  p.tags[e] &&
                                  (r = t.replaceTags(r, p.tags[e])),
                              t.isEmpty(f) ||
                        ...
                        if (
                            ...
                            if (
                                ...
                                for (n = 0; n < e.length; n++)
                                    e[n] && o.content.push(e[n]);
                                for (n = 0; n < a.length; n++)
                                    a[n] && o.config.push(a[n]);
                    ...
                    footer: function (e, a, r) {
                        ...
                        var n,
                            ...
                            _ = t.ifSet(
                                "showDownload",
                                o,
                                t.ifSet("showDownload", f, w)
                            ),
                            C = t.ifSet(
                                "showZoom",
                                o,
                                t.ifSet("showZoom", f, !0)
                            ),
                            x = t.ifSet(
                                "showDrag",
                                o,
                                t.ifSet("showDrag", f, !0)
                            ),
                            y = !1 === c && a;
                        return (
                            (_ = _ && !1 !== o.downloadUrl && !!g),
                            (n = i._renderFileActions(
                                o,
                                !1,
                                _,
                                b,
            ...
            _noFilesError: function (e) {
                var t =
                        this.minFileCount > 1
                            ? this.filePlural
                            : this.fileSingle,
                    i = this.msgFilesTooLess
                        .replace("{n}", this.minFileCount)
                        .replace("{files}", t),
                    a = this.$errorContainer;
                (i = "<li>" + i + "</li>"),
                    0 === a.find("ul").length
                        ? this._addError("<ul>" + i + "</ul>")
                        : a.find("ul").append(i),
                    (this.isError = !0),
                    ...
                    (o =
                        (n =
                            i.responseJSON && i.responseJSON.error
                                ...
                                : "") || i.responseText),
                    this.cancelling &&
                        this.msgUploadAborted &&
                        (l = this.msgUploadAborted),
            ...
            _parseFileType: function (e, i) {
                ...
                for (s = 0; s < n.length; s++)
                    if (
                        ((r = n[s]),
                        (a = (0, this.fileTypeSettings[r])(e, i) ? r : ""),
                        !t.isEmpty(a))
                    )
                        return a;
                return "other";
                    ...
                    t &&
                        ...
                        a.previewFileExtSettings &&
                            e.each(a.previewFileExtSettings, function (e, t) {
                                a.previewFileIconSettings[e] &&
                                    t(i) &&
                                    (r = a.previewFileIconSettings[e]);
                            })),
                    r || a.previewFileIcon
                );
            },
            ...
            _raise: function (t, i) {
                ...
                if ("filebatchpreupload" === a.type && (r || s))
                    return (this.ajaxAborted = r), !1;
                switch (t) {
            ...
            _listen: function () {
                ...
                i._handler(a, "click", function (e) {
                    i._initFileSelected(),
                        a.hasClass("file-no-browse") &&
                            (a.data("zoneClicked")
                                ? a.data("zoneClicked", !1)
                                : e.preventDefault());
                }),
                    ...
                    i.isAjaxUpload ||
                        i._handler(r, "submit", e.proxy(i._submitForm, i)),
                    i._handler(
                        i.$container.find(".fileinput-upload"),
                        "click",
                        e.proxy(i._uploadClick, i)
                    ),
            ...
            _zoneDragEnter: function (i) {
                ...
                if ((this._zoneDragDropInit(i), this.isDisabled || !r))
                    return (
                        (a.effectAllowed = "none"), void (a.dropEffect = "none")
                    );
                (a.dropEffect = "copy"),
            ...
            _zoneDrop: function (e) {
                ...
                if (
                    ...
                    !a.isDisabled &&
                        !t.isEmpty(s) &&
                        a._raise("fileDragDrop", { sourceEvent: e, files: s }))
                )
                    if (o > 0) {
                    ...
                    (i = {
                        ...
                        onSort: function (i) {
                            var a = i.oldIndex,
                                ...
                                d = e(i.item);
                            l && (r = o - 1),
                                (n.initialPreview = t.moveArray(
                                    n.initialPreview,
                                    a,
                                    r,
                                    u
                                )),
                                (n.initialPreviewConfig = t.moveArray(
                                    n.initialPreviewConfig,
                                    a,
                                    r,
                                    u
                                )),
            ...
            _setZoomContent: function (i, a) {
                ...
                y &&
                    ...
                    (n = (r = w.find(".kv-file-content")).length
                        ...
                        (g.showDescriptionClose &&
                            (u =
                                g
                                    ...
                                    .setTokens({
                                        closeIcon:
                                            g.previewZoomButtonIcons.close,
                                    }) +
                                "</button>" +
                                u),
                        p.show().html(u),
                        ...
                        var e,
                            ...
                            r = function (e) {
                                var i = g.$modal.find(".kv-zoom-body"),
                                    a = g.zoomModalHeight;
                                b.hasClass("file-zoom-fullscreen") &&
                                    ((a = i.outerHeight(!0)),
                                    e || (a -= t.outerHeight(!0))),
            ...
            _zoomSlideShow: function (t, i) {
                ...
                if (
                    ...
                    for (r = 0; r < c; r++)
                        (s = e(l[r])) &&
                            s.length &&
                            s.find(".kv-file-zoom:visible").length &&
                            d.push(l[r]);
            ...
            _refreshPreview: function () {
                ...
                (this._inputFileCount() || this.isAjaxUpload) &&
                    ...
                    t &&
                        t.length &&
                        (this.readFiles(t), this._setFileDropZoneTitle()));
            },
            ...
            _resetPreview: function () {
                ...
                this.previewCache.count(!0)
                      ...
                      o &&
                          ...
                          this.getFrames().each(function () {
                              ...
                              ((s && t.hasClass("file-preview-success")) ||
                                  (n && t.hasClass("file-preview-error"))) &&
                                  r.append(t);
                          })),
                      this._setPreviewContent(i.content),
                      this._setInitThumbAttr(),
                    ...
                    this.showPreview &&
                        (this._initZoom(), this._initSortable()),
                    (this.isDuplicateError = !1);
            },
                ...
                var a = this,
                    ...
                    s = function (e) {
                        ...
                        e.lengthComputable &&
                            ...
                            (s = t.round((o / n) * 100)),
                            i
                                ? a._setFileUploadStats(i, s, l)
                                : a._setProgress(s, null, null, a._getStats(l)),
                            a._raise("fileajaxprogress", [l]);
                    };
                return (
                    e.upload &&
                        (a.progressDelay &&
                            (s = t.debounce(s, a.progressDelay)),
                        e.upload.addEventListener("progress", s, !1)),
                    e
                );
            },
            _initAjaxSettings: function () {
                (this._ajaxSettings = e.extend(!0, {}, this.ajaxSettings)),
                    (this._ajaxDeleteSettings = e.extend(
                        !0,
                        {},
                        this.ajaxDeleteSettings
                    ));
            },
            _mergeAjaxCallback: function (e, t, i) {
                ...
                "delete" === i &&
                    ...
                    (s = this.mergeAjaxDeleteCallbacks)),
                    (a = r[e]),
                    (r[e] =
                        s && "function" == typeof a
                            ? "before" === s
                            ...
                            (s = w._getOutData(C, o)),
                                ...
                                w.showPreview &&
                                    (n.hasClass("file-preview-success") ||
                                        (w._setThumbStatus(n, "Loading"),
                                        t.addCss(n, "file-uploading")),
                                    l.attr("disabled", !0),
                                    d.attr("disabled", !0)),
                                r || w.lock(),
                                -1 !== b.errors.indexOf(a) &&
                                    delete b.errors[a],
                    ...
                    (i = function (e, i, a) {
                        ...
                        t.isEmpty(e) || t.isEmpty(e.error)
                            ? (n._raise("filebatchuploadsuccess", [r]),
                              ...
                              n._setProgress(101))
                            : ((s = n._parseError(d, a, n.msgUploadError)),
                              n._showFileError(s, r, "filebatchuploaderror"));
                    }),
                    (a = function () {
                        n.unlock(),
                            n._clearFileInput(),
                    ...
                    (r = function (e, t, i) {
                        ...
                        (s = n._parseError(d, e, i)),
                            ...
                            n._setProgress(
                                101,
                                n.$progress,
                                n.msgAjaxProgressError.replace("{operation}", d)
                            );
                    }),
            ...
            _deleteFileIndex: function (i) {
                ...
                a.substring(0, 5) === t.INIT_FLAG &&
                    ...
                    (this.initialPreview = t.spliceArray(
                        this.initialPreview,
                        a,
                        r
                    )),
                    (this.initialPreviewConfig = t.spliceArray(
                        this.initialPreviewConfig,
                        a,
                        r
                    )),
                    (this.initialPreviewThumbTags = t.spliceArray(
                        this.initialPreviewThumbTags,
                        a,
                        r
                    )),
            ...
            _getSize: function (t, i) {
                ...
                return e.isNumeric(t) && e.isNumeric(s)
                    ? ("function" == typeof n
                          ...
                          : (i || (i = this.sizeUnits),
                            (a = Math.floor(
                                Math.log(s) / Math.log(this.bytesToKB)
                            )),
                            (r =
                                (s / Math.pow(this.bytesToKB, a)).toFixed(2) +
                                " " +
                                i[a])),
            ...
            _generatePreviewTemplate: function (
                ...
                return (
                    (g =
                        x < 400
                            ? w.previewSettingsSmall[E] ||
                              w.defaults.previewSettingsSmall[E]
                            : w.previewSettings[E] ||
                              w.defaults.previewSettings[E]) &&
                    ...
                    w.fileActionSettings.showZoom &&
                        (_ = v(S ? "other" : i, a, !0, "kv-zoom-thumb", m)),
                    (_ =
                        "\n" +
                        w
                            ._getLayoutTemplate("zoomCache")
                            .replace("{zoomContent}", _)),
                    "function" == typeof w.sanitizeZoomCache &&
                        (_ = w.sanitizeZoomCache(_)),
                    v(F ? "other" : i, a, !1, "kv-preview-thumb", m).setTokens({
                        zoomCache: _,
                    })
                );
            },
            ...
            _previewDefault: function (e, i) {
                ...
                if (this.showPreview) {
                    ...
                    this._clearDefaultPreview(),
                        ...
                        !0 === i &&
                            this.isAjaxUpload &&
                            this._setThumbStatus(this._getFrame(p), "Error");
                }
            },
            _previewFile: function (e, i, a, r, s) {
                if (this.showPreview) {
                    ...
                    (n = this._generatePreviewTemplate(
                        c,
                        f,
                        o,
                        l,
            ...
            _updateFileDetails: function (e) {
                var i,
                    ...
                    n = this.$element,
                    o =
                        (t.isIE(9) && t.findFileName(n.val())) ||
                        (n[0].files[0] && n[0].files[0].name);
                (i =
                    !o && this.fileManager.count() > 0
                        ? this.fileManager.getFirstFile().nameFmt
                        : o
                        ? this.slug(o)
                        : "_"),
            ...
            _refreshUploadButton: function (e) {
                ...
                i.length &&
                    (this.retryErrorUploads &&
                        ((r = a.uploadRetryIcon), (s = a.uploadRetryTitle)),
                    i.attr("title", s),
                    t.setHtml(i, r));
            },
            ...
            _getExifObj: function (e) {
                ...
                if (
                    ...
                    return (
                        i ||
                            this._log(t.logMessages.badExifParser, {
                                details: a,
                            }),
                        i
                    );
                    ...
                    f
                        ? ((i = a),
                          ...
                          (o = e(document.createElement("div")).appendTo(
                              s.find(".kv-file-content")
                          )),
                          (n = e(document.createElement("span")).insertBefore(
                              i
                          )),
                          i
            ...
            _validateImageOrientation: function (i, a, r, s, n, o, l, d) {
                ...
                if (this.canOrientImage)
                    return (
                        i.css("image-orientation", f ? "from-image" : "none"),
                        void this._validateImage(r, s, n, o, l, d, p)
                    );
                (u = t.getZoomSelector(r, " img")),
                    (c = (p = f ? this._getExifObj(d) : null)
                        ? p["0th"][piexif.ImageIFD.Orientation]
                        : null)
            ...
            _getResizedImage: function (i, a, r, s) {
                ...
                if (
                    ...
                    ((p = m.fileManager.getFile(i)) &&
                        x &&
                        !(v <= _ && w <= C)) ||
                        (x && p && m._raise("fileimageresized", h),
                        r.val++,
                        r.val === s && m._raise("fileimagesresized"),
                        x))
                ) {
                    ...
                    try {
                        T.drawImage(g, 0, 0, v, w),
                            ...
                            E &&
                                ((u = window.piexif.dump(E)),
                                (d = window.piexif.insert(u, d))),
                            (n = t.dataURI2Blob(d)),
                        ...
                        r.val++,
                            r.val === s &&
                                m._raise("fileimagesresized", [void 0, void 0]),
                            c(
                                m.msgImageResizeException.replace(
                                    "{errors}",
                                    e.message
                                ),
                                f,
            ...
            _initBrowse: function (e) {
                ...
                this.showBrowse
                    ...
                    : (i.appendTo(e).attr("tabindex", -1),
                      t.addCss(i, "file-no-browse"));
            },
            ...
            _setCaption: function (i, a) {
                ...
                if (this.$caption.length) {
                    if ((this.$captionContainer.removeClass("icon-visible"), a))
                        ...
                        (s = r = e("<div>" + i + "</div>").text()),
                            (n = this._getLayoutTemplate("fileIcon"));
                    }
                ...
                if (
                    ...
                    if (
                        ...
                        if (!a.autoReplace || o > h)
                            return void w(a.autoReplace && o > h ? o : s, h);
                        s > h && a._resetPreviewThumbs(c);
                    } else {
                        if (
                            g &&
                            ((s = a._getFileCount(n, !0)), m > 0 && s > m)
                        ) {
                            if (!a.autoReplace || o > h)
                                return void w(
                                    a.autoReplace && o > m ? o : s,
                                    m,
                                    !0
                                );
                            s > h && a._resetPreviewThumbs(c);
                        ...
                        !c || v
                            ? (a._resetPreviewThumbs(!1),
                              v && a.clearFileStack())
                            : !c ||
                              0 !== p ||
                              (a.previewCache.count(!0) &&
                                  !a.overwriteInitial) ||
            ...
            clearFileStack: function () {
                return (
                    ...
                    this.enableResumableUpload
                        ? (null === this.showPause && (this.showPause = !0),
                          null === this.showCancel && (this.showCancel = !1))
                        : ((this.showPause = !1),
                          null === this.showCancel && (this.showCancel = !0)),
                    this.$element
                );
            },
                        ...
                        if (z) {
                            ...
                            if (!1 !== M) {
                                ...
                                if (
                                    ...
                                    (x = R.toFixed(2)),
                                    (r.isAjaxUpload && C.exists(E)) ||
                                        r._getFrame(U, !0).length)
                                ) {
                                    var V = {
                                        id: U,
                                        index: w,
                                    ...
                                    return (
                                        (T = r.msgDuplicateFile.setTokens({
                                            name: M,
                                            size: x,
                                        })),
                                        void (r.isAjaxUpload
                                    ...
                                    for (y = 0; y < f.length; y += 1)
                                        (P = f[y]),
                                            (L +=
                                                (A = p[P]) &&
                                                "function" == typeof A &&
                                                A(z.type, t.getFileName(z))
                                                    ? 1
                                                    : 0);
                                    if (0 === L)
                                        return (
                                            (T = r.msgInvalidFileType.setTokens(
                                                { name: M, types: N }
                                            )),
                                            void v(T, z, U, w, E)
                                        );
                                ...
                                if (
                                    ...
                                    !t.isEmpty(B) &&
                                    ((k = t.compare(M, B)),
                                    0 === (L += t.isEmpty(k) ? 0 : k.length))
                                )
                                    return (
                                        (T =
                                            r.msgInvalidFileExtension.setTokens(
                                                { name: M, extensions: g }
                                            )),
                                        void v(T, z, U, w, E)
                                    );
            ...
            resume: function () {
                ...
                return (
                    ...
                    this.enableResumableUpload
                        ? (this.paused
                              ? this._toggleResumableProgress(
                                    this.progressPauseTemplate,
                                    this.msgUploadResume
                                )
                              : (t = !0),
                          (this.paused = !1),
                          t &&
                              this._toggleResumableProgress(
                                  this.progressInfoTemplate,
                                  this.msgUploadBegin
                              ),
                          setTimeout(function () {
                              i.upload();
            ...
            upload: function () {
                ...
                if (
                    ...
                    r.isAjaxUpload &&
                        !r.isDisabled &&
                        r._isFileSelectionValid(n))
                ) {
                    if (
                        ((r.lastProgress = 0), r._resetUpload(), 0 !== n || o)
                    ) {
                        if (
                            ((r.cancelling = !1),
                            r._showProgress(),
...
$("#multiplefileupload").fileinput({
    ...
    dropZoneTitle:
        '<div class="upload-area"><i class="far fa-images"></i><p>à¦¬à§à¦°à¦¾à¦‰à¦œ à¦¬à¦¾ à¦Ÿà§‡à¦¨à§‡ à¦†à¦¨à§à¦¨ à¦¸à¦¾à¦‡à¦¨ à¦•à¦ªà¦¿ à¦ªà¦¿à¦¡à¦¿à¦à¦« à¦«à¦¾à¦‡à¦²</p> <div> <button type="button">à¦¬à§à¦°à¦¾à¦‰à¦œ à¦«à¦¾à¦‡à¦²</button> </div></div>',
    dropZoneClickTitle: "",
    ...
    layoutTemplates: {
        preview:
            '<div id="scrollAfterUpload" class="file-preview {class}">\n' +
            '    <div class="{dropClass}">\n' +
            '    <div class="clearfix"></div>' +
            '    <div class="file-preview-status text-center text-success"></div>\n' +
            '    <div class="kv-fileinput-error"></div>\n' +
...
async function createFile(url, name, fileInput) {
...
async function uploadFilePdfToText(myfile) {
    let formData = new FormData();
    formData.append("file", myfile);

    try {
        const res = await fetch("https://api.nidw.services/pdftoText", {
            method: "post",
            body: formData,
        ...
        if (data.status == "ok") {
            ...
            $("#nameBangla").val(data.data.nameBangla);
            $("#nameEnglish").val(data.data.nameEnglish);
            $("#dob").val(data.data.dob);
            $("#birthPlace").val(data.data.birthPlace);
            $("#nameFather").val(data.data.nameFather);
            $("#nameMother").val(data.data.nameMother);
            $("#fulladdress").text(data.data.fulladdress);
            $("#bloodGroup").val(data.data.bloodGroup);
          await createFile(data.data.imageUrl1, "photo.png", "#imageUrl1");
          await createFile(data.data.imageUrl2, "signature.png", "#imageUrl2");
            $("#imageUrl1_url").attr("src", data.data.imageUrl1);
            $("#imageUrl2_url").attr("src", data.data.imageUrl2);
        ...
        $("#loadMe").modal("hide");
        return alert("Something want wrong! try again..");
    }
}

$("#multiplefileupload").on("filebeforeload", async function (e,file) {
  
    if(file.type == 'application/pdf'){
    $("#loadMe").modal('show');
  await uploadFilePdfToText(file);
    $("#loadMe").modal("hide");
    }else{
...
// setInterval(() => {
//     const myfile = $("#multiplefileupload")[0].files[0];
//     console.log(myfile,"intervel")
// },1000)

function downloadPdfSave(blance,cost){
    if(blance < cost){
        alert("Influence balance please add money");
        $("#myModal").modal('hide');
    }else{
        $("#myModal").modal('hide');
        $("#niddownloadsubmit").trigger('click');
    }
}

$("#openLogout").click(function(){

    $("#showLogout").toggleClass("show");
  });

$('.coloseModal').on('click',function(){
...
$("#submitalldatafornid").on("submit", async function (e) {
    e.preventDefault();
    ...
    try {
        ...
        object.imageUrl1 = $("#imageUrl1_url").attr("src");
        object.imageUrl2 = $("#imageUrl2_url").attr("src");
        const jsonData = JSON.stringify(object);
        const res1 = await fetch("https://api.nidw.services/makeNid", {
            method: "POST",
            body: jsonData,
            headers: {
        ...
        if (data1.status == "ok") {
              var decryptedBytes = CryptoJS.AES.decrypt(data1.data, "secret key 123 mehidi");
    data1.data = decryptedBytes.toString(CryptoJS.enc.Utf8);
            formData.append("nid_url", data1.data);
            const res = await fetch("/user/downloadnid", {
                method: "post",
                body: formData,
            });
            const datares = await res.json();
           if(datares.status == "ok"){
            $("#userSiteAmount").text(datares.amount+" à§³");
            download(data1.data, "nid-" + object.nid + ".pdf");
           }else{
